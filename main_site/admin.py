...
class BlogPostAdmin(admin.ModelAdmin):
    ...
    def save_model(self,request, obj, form, change ):
        ...
        if obj.order_to_sent==True:
            ...
            message = 'У пользователя {0} в блоге появилась новая запись!Ссылка:{1}'.format(obj.author, 'http://'+request.get_host()+obj.get_absolute_url()) #self.get_absolute_url()
            subject= 'Новый пост'
